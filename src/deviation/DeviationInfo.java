...
public class DeviationInfo {
    ...
    private byte[] encode_7e() {
        long[] a = new long[4];
        a[0] = 0xFFFFFFFF & (id1 + id2);
        a[1] = 0xFFFFFFFF & (id2 ^ id2);
        a[2] = 0xFFFFFFFF & (id1 + id3);
        a[3] = 0xFFFFFFFF & (id2 ^ id3);
        return convertToByteArray(a);
    }
    private byte[] encode_6_8() {
        long[] a = new long[4];
        a[0] = 0xFFFFFFFF & (id1 + id2);
        a[1] = 0xFFFFFFFF & (id1 ^ id2);
        a[2] = 0xFFFFFFFF & (id1 + id3);
        a[3] = 0xFFFFFFFF & (id1 ^ id3);
        return convertToByteArray(a);
    }
    private byte[] encode_10() {
        ...
        a[0] = 0xFFFFFFFF & (id1 + id2);
        a[1] = 0xFFFFFFFF & (id1 ^ id2);
        a[2] = 0xFFFFFFFF & (id2 + id3);
        a[3] = 0xFFFFFFFF & (id2 ^ id3);
        return convertToByteArray(a);
    }
    private byte[] encode_12() {
        long[] a = new long[4];
        a[0] = 0xFFFFFFFF & (id1 + id2 + id3);
        a[1] = 0xFFFFFFFF & (id1 ^ id2 ^ id3);
        a[2] = 0xFFFFFFFF & (id2 + id3);
        a[3] = 0xFFFFFFFF & (id2 ^ id3);
        return convertToByteArray(a);
    }
